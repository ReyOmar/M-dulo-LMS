...
export class MailService implements OnModuleInit {
  ...
  private readonly SAFE_TEMPLATE_KEYS = new Set([
    ...
    'resetUrl',
    'mensaje_aprobacion',
    'progreso_cursos', // Pre-formatted HTML blocks generated by server
  ]);
  ...
  async sendChatNotification(email: string, nombre: string, remitente: string, mensaje: string, origen: string) {
   ...
   */
  async sendCertificateGenerated(
    email: string,
    nombre: string,
    cursoTitulo: string,
    codigo: string,
